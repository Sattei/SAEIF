        ...
        <div className="relative z-10 w-full h-full flex flex-col">
          ...
          <div className="flex-1 flex flex-col justify-center items-center px-4">
            ...
            <p className="text-xl md:text-2xl text-white max-w-4xl leading-relaxed mb-16 text-left">
              Your contribution helps us bridge the skill gap in India,
              transforming lives and building a stronger workforce. Every
              donation, no matter the size, creates ripples of positive change
              across communities.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Support our mission through secure and convenient payment options.
              Every contribution helps us create more opportunities for skill
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Scan and pay instantly using any UPI app.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard("Skill Aid Empower India Foundation")
                      }
                ...
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => copyToClipboard("101841316426")}
                      className="text-accent hover:text-accent/80"
                    >
                      <FaCopy />
                    </button>
                ...
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => copyToClipboard("IDFB0020187")}
                      className="text-accent hover:text-accent/80"
                    >
                      <FaCopy />
                    </button>
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> Please include "SAEIF Donation" in the
                  transfer description and send transaction details for email
                  confirmation.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Generate your official donation receipt for tax deduction under
              Section 80G. All donations to SAEIF are eligible for tax benefits.
            </p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-4">
                  Receipts for donations above ₹2,000.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-600 text-center">
                    Receipt will be downloaded as a pdf file. You can also
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-gray-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">
                Registered under Section 80G for tax deductions
              </p>
            </div>
            <div className="bg-gray-800 rounded-lg p-6 text-center">
            ...
            <div className="bg-gray-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">
                Regular audits and public disclosure of funds
              </p>
            </div>
            <div className="bg-gray-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">
                Foreign Contribution Regulation Act compliant
              </p>
            </div>
          </div>
